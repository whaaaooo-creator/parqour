const APP_VERSION = '20260414pro2';
const APP_CACHE = 'parqour-cache-' + APP_VERSION;
const CORE_ASSETS = [
  './',
  './index.html',
  './index.html?v=20260414pro2',
  './counter.html',
  './counter.html?v=20260414pro2',
  './report.html',
  './report.html?v=20260414pro2',
  './support2.html',
  './support2.html?v=20260414pro2',
  './autofetch.html',
  './autofetch.html?v=20260414pro2',
  './style.css',
  './style.css?v=20260414pro2',
  './i18n.js',
  './numeric.js',
  './pwa-update.js?v=20260414pro2',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
...
self.addEventListener('fetch', (e) => {
  ...
  e.respondWith((async () => {
    ...
    try {
      ...
      if (e.request.mode === 'navigate') return (await cache.match('./index.html?v=20260414pro2')) || (await cache.match('./index.html')) || Response.error();
