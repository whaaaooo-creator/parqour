...
const CORE_ASSETS = [
  './',
  './index.html',
  './index.html?v=20260413fix3',
  './counter.html',
  './counter.html?v=20260413fix3',
  './report.html',
  './report.html?v=20260413fix3',
  './support2.html',
  './support2.html?v=20260413fix3',
  './autofetch.html',
  './autofetch.html?v=20260413fix3',
  './style.css',
  './style.css?v=20260413fix3',
  './i18n.js',
  './numeric.js',
  './pwa-update.js?v=20260413fix3',
  './icon-180.png',
  './icon-192.png',
  './icon-512.png',
...
self.addEventListener('fetch', (e) => {
  ...
  e.respondWith((async () => {
    ...
    try {
      ...
      if (e.request.mode === 'navigate') return (await cache.match('./index.html?v=20260413fix3')) || (await cache.match('./index.html')) || Response.error();
